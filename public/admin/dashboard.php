...
<div class="stat-grid">
    <a class="stat-card" href="manage_users.php">
    ...
    <a class="stat-card" href="all_tasks.php">
    ...
    <a class="stat-card" href="all_tasks.php?filter=overdue">
    ...
    <a class="stat-card" href="all_tasks.php?filter=no_deadline">
    ...
    <a class="stat-card" href="all_tasks.php?filter=due_today">
